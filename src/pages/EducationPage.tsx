    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="py-16 container mx-auto px-4">
        ...
        <div className="space-y-6">
          {[
            { name: 'IDEB Iniciais', value: '5,8', change: '+0,3 vs 2023' },
            { name: 'IDEB Finais', value: '4,9', change: '+0,2 vs 2023' },
          ].map((item) => (
            <div key={item.name} className="p-6 rounded-lg shadow-soft bg-muted">
              ...
              <div className="flex items-center gap-4">
                <div className="flex-1 bg-border rounded-full h-3">
                  <div className="bg-secondary h-3 rounded-full transition-all" style={{ width: `${(parseFloat(item.value) / 10) * 100}%` }} />
                </div>
